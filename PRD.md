...
**Acceptance Criteria:**
- [x] Run conversion: `node bin/run.js bim-to-sml --source /Users/dianne/Downloads/bim/fails/Ulta_bim.json --output /tmp/sml-out --clean`
- [x] Run deploy from `/Users/dianne/go/src/github.com/AtScaleInc/SML/tests/snowflake-converter`: `pnpm pbi-deploy /Users/dianne/Downloads/bim/fails/Ulta_bim.json`
- [x] If deploy succeeds (exit 0): document in progress.txt and mark complete
...
**Result:** Deployed successfully after fixing two bugs:
1. Encoded metric unique_names not resolving (e.g., "GR Value w/o BOM" → "GR Value w_o BOM")
2. ROUNDUP/ROUNDDOWN DAX functions producing invalid MDX (now added to unconvertible list)
...
**Acceptance Criteria:**
- [x] Run conversion: `node bin/run.js bim-to-sml --source /Users/dianne/Downloads/bim/fails/POC_bim.json --output /tmp/sml-out --clean`
- [x] Run deploy from `/Users/dianne/go/src/github.com/AtScaleInc/SML/tests/snowflake-converter`: `pnpm pbi-deploy /Users/dianne/Downloads/bim/fails/POC_bim.json`
- [x] If deploy succeeds (exit 0): document in progress.txt and mark complete
...
**Result:** Deployed successfully after fixing one bug:
1. COUNTROWS measures referencing unused tables produced invalid MDX `[Measures].[]`
