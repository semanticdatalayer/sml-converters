...
const getDimension = (dim: SMLDimension) => getFreezedObject(dim);
...
const dateDimension = getDimension({
  ...
  level_attributes: [
    ...
    },
    {
      ...
      time_unit: SMLDimensionTimeUnit.HalfYear,
    },
    {
      unique_name: "ReportIng_Month",
...
export const dimensions = getAggregatedResult<SMLDimension, typeof allDimensions>(allDimensions);
