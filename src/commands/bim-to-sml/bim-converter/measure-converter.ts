...
export class MeasureConverter {
  ...
  async metricFromCalc(
    ...
    try {
      ...
      const fallbackValue = getFallbackValue(daxExpression);
      pipelineResult = {
        success: false,
    ...
    let mdxExpression = pipelineResult.expression || `${getFallbackValue(daxExpression)} /* TODO: ${escapeForComment(daxExpression)} */`;
